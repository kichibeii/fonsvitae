...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="daftarguru.php"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> Daftar Guru</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"><a href="daftarguru.php">Daftar Guru</a> / Tambah Guru</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-xs-12 col-md-24 col-lg-12">
				...
				<table class="table">
					<tr>
						<td>Nama</td><td><input type = "text" placeholder = "Nama Panjang" name = "nama"></td>
					</tr>
					<tr>
						<td>NIP</td><td><input type = "text" placeholder ="NIP" name = "NIP"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input type  = "radio" name = "wali_kelas" value="1">Iya 
							<input type  = "radio" name = "wali_kelas" value="0">Tidak
						</td>
					</tr>
					<tr>
						<td>Status Penilaian Sikap</td>
						<td>
							<input type  = "radio" name = "sikap" value="1">Iya 
							<input type  = "radio" name = "sikap" value="0">Tidak
						</td>
					</tr>
					<tr>
						<td colspan="2"><input class = "btn" type="submit" value="Proses"></td>
					</tr>
				</table>
				</form>
			</div>
